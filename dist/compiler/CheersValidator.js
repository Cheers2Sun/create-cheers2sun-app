...
exports.CheersValidator = void 0;
class CheersValidator {
    validate(spec) {
        if (spec.version !== 1) {
            throw new Error(`Unsupported specification version: ${spec.version}`);
        }
...
exports.CheersValidator = CheersValidator;
